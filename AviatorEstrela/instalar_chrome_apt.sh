#!/bin/bash
# Solução definitiva: Remove Snap e instala Chrome via APT

set -e

echo ""
echo "  ============================================"
echo "   Solução Definitiva - Chrome via APT"
echo "  ============================================"
echo ""
...
echo ""
echo "[3/5] Adicionando repositório oficial do Google Chrome..."
...
echo "  ============================================"
echo ""
echo "Caminho para usar no código:"
echo "  $CHROME_REAL"
echo ""
