#!/bin/bash
# Wrapper que inicia o serviço com Xvfb (display virtual)

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
VENV_DIR="$SCRIPT_DIR/venv"

# Detecta se está rodando em ambiente sem display (servidor headless)
if [ -z "$DISPLAY" ]; then
    echo "Display não detectado. Iniciando com Xvfb..."
