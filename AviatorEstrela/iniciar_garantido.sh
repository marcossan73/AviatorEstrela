...
# Inicializao garantida - testa antes de iniciar
...
echo "   Aviator ML Intelligence - Inicializao"
...
if [ ! -f "$VENV_DIR/bin/activate" ]; then
    ...
    echo "ERRO: Ambiente virtual no encontrado!"
...
if command -v chromedriver &>/dev/null; then
    ...
    echo "  ? ChromeDriver no encontrado (Selenium tentar gerenciar automaticamente)"

fi



# 4. Teste rpido Selenium
...
if [ -z "$DISPLAY" ]; then
    ...
    echo "Display no detectado. Iniciando Xvfb..."
